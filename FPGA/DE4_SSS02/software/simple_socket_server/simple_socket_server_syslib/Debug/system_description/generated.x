 ...
 *
 * Generated: 2011-06-06 19:07:51.618
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x05080000, LENGTH = 32
    onchip_memory : ORIGIN = 0x05080020, LENGTH = 511968
    descriptor_memory : ORIGIN = 0x05101000, LENGTH = 2048
    ext_flash : ORIGIN = 0x02000000, LENGTH = 33554432
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_memory = 0x05080000 ;
 __alt_mem_descriptor_memory = 0x05101000 ;
 __alt_mem_ext_flash = 0x02000000 ;
...
PROVIDE( __alt_heap_limit    = 0x050fd000 );
