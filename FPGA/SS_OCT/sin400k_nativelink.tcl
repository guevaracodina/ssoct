...
set ipfs_ext "vo"
if {[file exists sin400k.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find sin400k.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME sin400k_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.sin400k_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "sin400k.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "sin400k_tb.${hdl_ext}" -section_id tb -library work
