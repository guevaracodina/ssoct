-- megafunction wizard: %Triple Speed Ethernet v9.0%
-- GENERATION: XML
...
ARCHITECTURE SYN OF tse_mac IS
	...
	GENERIC (
		...
		CORE_VERSION	: STD_LOGIC_VECTOR := X"0900";
...
-- Retrieval info: <MEGACORE title="Triple Speed Ethernet MegaCore Function"  version="9.0"  build="132"  iptb_version="1.3.0 Build 132"  format_version="120" >
...
-- Retrieval info:      <PRIVATE name = "atlanticSinkClockRate" value="83333333"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "atlanticSinkClockSource" value="pll"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "atlanticSourceClockRate" value="83333333"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "atlanticSourceClockSource" value="pll"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "avalonSlaveClockRate" value="83333333"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "avalonSlaveClockSource" value="pll"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "core_version" value="2304"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "cust_version" value="1"  type="INTEGER"  enable="1" />
-- Retrieval info:      <PRIVATE name = "dataBitsPerSymbol" value="8"  type="INTEGER"  enable="1" />
-- Retrieval info:      <PRIVATE name = "dev_version" value="2304"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "deviceFamily" value="STRATIXII"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "timingAdapterName" value="sgdma_rx"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "project_name" value="NiosII_stratixII_2s60_RoHS_TSE_SGDMA_sopc"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "DEVICE" value="EP2S60F672C3"  type="STRING"  enable="1" />
