 ...
 *
 * Generated: 2011-09-16 13:13:03.057
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x44080000, LENGTH = 32
    ddr2 : ORIGIN = 0x00000000, LENGTH = 1073741824
    onchip_memory : ORIGIN = 0x44080020, LENGTH = 511968
    ext_flash : ORIGIN = 0x42000000, LENGTH = 33554432
    descriptor_memory : ORIGIN = 0x44101800, LENGTH = 2048
}

    /* Define symbols for each memory base-address */
 __alt_mem_ddr2 = 0x00000000 ;
 __alt_mem_onchip_memory = 0x44080000 ;
 __alt_mem_ext_flash = 0x42000000 ;
 __alt_mem_descriptor_memory = 0x44101800 ;
...
SECTIONS
{
    ...
    .ddr2 : AT (LOADADDR (.bss) + SIZEOF (.bss))
    {
    ...
    .onchip_memory LOADADDR (.ddr2) + SIZEOF (.ddr2): AT (LOADADDR (.ddr2) + SIZEOF (.ddr2))
    {
    ...
    .ext_flash : AT (LOADADDR (.onchip_memory) + SIZEOF (.onchip_memory))
    {
    ...
    .descriptor_memory : AT (LOADADDR (.ext_flash) + SIZEOF (.ext_flash))
    {
...
PROVIDE( __alt_heap_limit    = 0x440fd000 );
